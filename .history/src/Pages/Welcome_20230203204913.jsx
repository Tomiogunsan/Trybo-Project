    ...
    <SubHeader />
     ...
     <div className="flex flex-col items-center justify-center  mt-8 px-6">
      ...
      mb-8 mr-[100px] ">Welcome (user firstName)</h2>
        <h4 className='text-md w-[380px] mr-6 text-[#202834] mb-8'>With your new Trybo account, the world is within your reach.</h4>

        <p className='mr-[340px] mb-10 text-blue-700 '>Continue</p>
    </div>
    </div>
    </>
