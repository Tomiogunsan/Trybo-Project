      ...
      mb-6 "
        ...
        >
          ...
          >
           ...
           <Link to='/forg0t-password' className='mb-6 mt-4 border-b-[1px] border-blue-600 text-blue-600'>Forgot password</Link>
          <div className='flex mb-10'>
            <p className='mr-2 text-[#556987]'>Don't have an account?</p>
            <p>
              <Link to="/sign-up" className='text-sm text-blue-600 font-semibold'>Create one</Link>
            </p>
          </div>
