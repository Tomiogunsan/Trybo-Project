    ...
    <>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute w-full h-full left-0 top-0 bg-gray-500/30 ">
          {step === 1 ? <div className="absolute top-[80px] md:right-[300px] md:top-[10%] bg-white w-full md:max-w-[35%] rounded-xl px-8 
      ...
      rounded-md mb-6'
      />
          </div> : <div className="absolute top-[80px] md:right-[300px] md:top-[10%] bg-white w-full md:max-w-[35%] rounded-xl px-8 
          shadow-lg shadow-black">
