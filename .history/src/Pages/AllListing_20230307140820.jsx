...
export default function AllListing() {
  ...
  async function upvote(listingId){
    ...
    console.log(docRef);
    // const listingToBeUpdated = homeListing.find((item) => item.listingId === listingId)
    // await updateDoc(docRef,listingToBeUpdated[0]?.vote++)
  }
  return (
    <>
    <SubHeader />
          ...
          <div>
            ...
            <div className='flex justify-between mt-4'>
              <div className='flex items-center'>
                <AiTwotoneStar className='text-yellow-600 text-xl' onClick={() => upvote(listingId)}/>
                <p >{listing.vote}</p>
              </div>
