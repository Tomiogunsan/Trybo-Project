                ...
                <section name='profile'>
                    ...
                    <form className='flex flex-col py-4' >
                        ...
                        />
                            ...
                            className='text-red-600 ml-4  hover:text-red-800 cursor-pointer'>
                               {changeDetail ? 'Apply change' : 'Edit'}
                            </span>
                            </p>
                           <Link></Link> <p className='mt-4 text-lg  text-blue-600 hover:text-blue-800 cursor-pointer'>Check your Listings</p>
                            <p onClick={onLogOut} className='mt-4 text-lg  text-blue-600 hover:text-blue-800 cursor-pointer'>Sign out</p>
