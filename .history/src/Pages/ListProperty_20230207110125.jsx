    ...
    <>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute w-full h-full left-0 top-0 bg-gray-500/30 ">
          <form className="absolute top-[80px] md:right-[300px] md:top-[30%] bg-white w-full md:max-w-[35%] rounded-xl px-8 shadow-lg shadow-black">
      ...
      <div className="flex space-x-6 mb-6 w-full">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="w px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center"
            />
          </div>
          <div>
