  ...
  return (
    ...
    <div className='md:max-w-7xl md:mx-auto mt-6'>
      {homeListing.map((listing, index) => (
        <div className={`grid md:grid-cols-2 mdw-[70%] text-[#404040] mb-6 ${homeListing.length - 1 === index ? 'border-b-0' : 'border-b-2 border-gray-300'}`}>
          <div className='ml-10  w-full md:w-[80%]'>
            <img 
          ...
          <div>
            <div className='flex flex-col px-4 md:px-0 mt-6  '>
            ...
            <div className='flex md:justify-between mt-4'>
              ...
              <div className='md:border md:border-blue-800 px-4 py-2 rounded-lg'>${listing.price} per Night</div>
            </div>
            </div>
