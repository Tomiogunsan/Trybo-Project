    ...
    useEffect(()=> {
        async function fetchListing(){
            ...
            if(docSnap.exists()){
                ...
                docSnap.data().name && props.handleBookingDetails('roomName', 'first') 
                // docSnap.data().price && props.handleBookingDetails('price', docSnap.data().price)u                setLoading(false)
  ...
  return (
    <main>
      ...
      <div className=' max-w-6xl mx-auto mt-10 px-4 grid md:grid-cols-2 gap-20'>
        ...
        <button onClick={props.showBookingDetails}
