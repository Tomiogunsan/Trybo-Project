            ...
            <div>
                ...
                <section name='profile'>
                    ...
                    <form className='flex flex-col py-4' >
                        ...
                        onChange={onChange}
                        value={name}
                        className={` w-[70%] mdw-1/2 mb-4 px-4 py-4 border-[1px] border-[#c0c0c0] rounded-md ${changeDetail && 'bg-red-200'}`}
                        />
                        ...
                        />
                            ...
                            <p onClick={onLogOut} className='mt-8 text-lg  text-blue-600 hover:text-blue-800 cursor-pointer'>Sign out</p>
