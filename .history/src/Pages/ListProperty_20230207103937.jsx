  ...
  return (
    <>
      ...
      <div className="relative w-full">
        ...
        />
        <div className="absolute w-full h-full left-0 top-0 bg-gray-500/30 shadow-xl">
          <form className="absolute right-[100px] top-[30%] bg-white w-[45%] rounded-xl px-8">
      ...
      {/* // value={value}
      // onChange={setValue} */}
      <p>Add a link to your website or a link that displays the home photos</p>
