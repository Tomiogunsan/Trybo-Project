  ...
  return (
    <main>
      ...
      {shareLinkCopied && (
        ...
        {/* <Container> */}
      <div className=' max-w-6xl mx-auto mt-10 px-4 grid md:grid-cols-2 gap-12'>
        ...
        <div className=' mx-12 w-[350px]  rounded-lg shadow-lg md:mx-0 '>  
        <div className='flex'>
        <div className='flex items-center p-4'>
            <MdOutlineBed className='text-2xl mr-4'/>
        <p className='text-lg'>{listing.bedrooms > 1 ? `${listing.bedrooms} Beds` : "1 Bed"}</p>
        </div>
        <div className='flex items-center p-4'>
        <FaBath className='text-xl mr-4'/>
        <p className='text-lg'>{listing.bathroom > 1 ? `${listing.bathroom} Bathrooms` : "1 Bathroom"}</p>
        </div>
        </div>
        
        <p className='border-[1px] border-gray-200 px-2'></p>
        ...
        <p></p>{listing.furnished ? "Furnished" : "Not furnished"}
        </div>
        </div>
        <p className='border-[1px] border-gray-200 px-2'></p>
        </div>
