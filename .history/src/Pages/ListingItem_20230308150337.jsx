...
export default function Listing(props) {
  ...
  const {bookingDetails, handleBookingDetails}= useListing()
  ...
  useEffect(() => {
    async function fetchListing() {
      ...
      if (docSnap.exists()) {
        ...
        handleBookingDetails('roomName', docSnap.data().name)
        handleBookingDetails('price', docSnap.data().price)
        setLoading(false)
      }
    }
    console.log(bookingDeta);
    fetchListing()
  }, [params.listingId])
  ...
  return (
    <main>
      ...
      <div
        className="fixed top-[4%] right-[3%] z-10 bg-white cursor-pointer border-2 border-gray-400 rounded-full w-12 h-12 flex justify-center items-center"
        onClick={() => {
        ...
        <div className=" max-w-6xl mx-auto mt-10 px-4 grid md:grid-cols-2 gap-20">
          <div className=" sm:w-[350px] lg:w-full ">
            <div className="flex flex-col  justify-between mb-2">
              ...
              <div className="w-[150px]  mt-4 mb-2 ">
                <p className="bg-green-800 text-white px-4 py-2 capitalize rounded-lg font-semibold">
            ...
            <p className="text-base tracking-wider mt-4 mr-2">
              {listing.description}
            </p>
            ...
            <div className=" mt-24 flex bg-blue-100  items-center gap-4 text-gray-800 mr-[4px] py-2">
              ...
              <div>
                <p className="font-semibold">
                  Peace of mind guaranteed with every booking.
                </p>
                <p className="text-sm">
                  We promise expert-vetted homes, total transparency and
                  exceptional service.
                </p>
              </div>
            </div>
          ...
          <div className=" lg:mx-12 w-[300px] lg:w-[370px]  rounded-3xl shadow-xl md:mx-0 text-gray-700">
            ...
            <div className="flex items-center justify-center mb-4">
              <button
                onClick={props.showBookingDetails}
                className="bg-blue-800 text-white uppercase items-center px-16 py-2 rounded-full hover:bg-blue-900 cursor-pointer"
              >
                Check Availability
              </button>
            </div>
