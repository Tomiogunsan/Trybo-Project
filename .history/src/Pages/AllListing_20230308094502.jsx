import { collection, doc, getDocs, orderBy, query, updateDoc, update, limit, limitToLast } from 'firebase/firestore'
...
export default function AllListing() {
  ...
  async function fetchListings() {
    try {
      ...
      // create the query
      const q = query(listingRef, orderBy('timestamp', 'desc') limitToLast(3))
      // execute the query
