    ...
    <>
      ...
      mb-6 "
        ...
        >
          ...
          <button
            type="submit"
            className="bg-blue-600 text-white px-4 w-full md:w-[]py-4 mb-2 mt-4 rounded-3xl
           text-lg hover:bg-blue-800"
          >
            Sign in
          </button>

           <Link to='' className='mb-6 mt-4 border-b-[1px] border-blue-600 text-blue-600'>Forgot password</Link>
          <div className='flex mb-10'>
            <p className='mr-2 text-[#556987]'>Don't have an account?</p>
            <p>
              <Link to='sign-up' className='text-sm text-blue-600'>Create one</Link>
            </p>
          </div>
