  ...
  return (
    <main>
      ...
      <div className=' mx-12 w-[400px]  rounded-md shadow-lg md:mx-0 '>  est. Maxime maiorAut, natus veniam?</div>
        <div className='bg-red-600  '>rnatur. Veritatis consequuntur aliquid quia dolorem blanditiis pariatur natus, eum eius unde quibusdam reprehenderit et eveniet esse?</div>
