              ...
              >
                ...
                <div className="flex w-full space-x-6 mb-6 ">
                  <div className="w-1/2">
                    ...
                    />
                    {errors.bedrooms && <span className='text-red-600 capitalize'>{errors.beds }</span>}
                  </div>
                  <div className="w-1/2">
               ...
               />
                ...
                {errors.parking && <span className='text-red-600 capitalize'>{errors.parking }</span>}
                {errors.furnished && <span className='text-red-600 capitalize'>{errors.furnished }</span>}
               </div>
                ...
                <input
                  ...
                  className="w-full px-4 py-4  text-xl text-gray-700 bg-white border-[1px] border-[#556987]  rounded-md"
                />
                {errors.address && <span className='text-red-600 capitalize'>{errors.address }</span>}
                </div>
                ...
                />
                {errors.description && <span className='text-red-600 capitalize'>{errors.description }</span>}
                </div>
