  ...
  return (
    <main>
      ...
      <div className='  px-4 flex md:flex-row  sm:flex-col'>
        ...
        <div className='fixed w-64 smmx-12 bg-blue-700'> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maxime temporibus praesentium esse iure, voluptas est. Maxime maiores facilis culpa provident! Nihil unde modi cum, vel minima eum? Aut, natus veniam?</div>
      </div>
      {/* </Container> */}
    </main>
  )
