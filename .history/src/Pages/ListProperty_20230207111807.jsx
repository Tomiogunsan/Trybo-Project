...
export default function ListProperty() {
  return (
    <>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute w-full h-full left-0 top-0 bg-gray-500/30 ">
          <form className="absolute top-[80px] md:right-[300px] md:top-[10%] bg-white w-full md:max-w-[35%] rounded-xl px-8 shadow-lg shadow-black">
            ...
            className='w-full  px-4 py-2 border-[1px] border-[#556987] rounded-md mb-6'/>
            <input placeholder='Email' type='email'
            className='w-full  px-4 py- border-[1px] border-[#556987] 
            rounded-md mb-6' />
            <PhoneInput
      ...
      <input type='file' 
      className='w-full  px-4 py-2 border-[1px] border-[#556987] 
      rounded-md mb-6'
      />
