        ...
        <Dashboard>
            <div>
                ...
                <section name='profile'>
                    ...
                    <form className='flex flex-col py-4' >
                        ...
                        />
                            ...
                            <span className='text-blue-600 ml-4 font-semibold hover:text-blue-800 cursor-pointer'>
                                Edit
                            </span>
                            </p>
                            <p className='mt-8 text-lg font-semibold text-blue-600 hover:text-blue-800 cursor-pointer'>Sign out</p>
                ...
                <p className='font-semibold text-lg'>Your current verifications</p>
                    {auth?.currentUser?.emailVerified === 'true' ? <p>Email is confirmed</p>: <p>Email is not confirmed</p>}
                </section>


{/* settings */}
                <section className=' mt-16md:mt-[200px]' name="settings">
