    ...
    <>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute w-full h-full left-0 top-0 bg-gray-700/30">
          <form className="absolute right-[100px] top-[30%] bg-red-800  w-[45%] rounded-lg px-8">
            ...
            className='w-full  px-4 py-4 border-2 border-[#556987] rounded-md mb-'/>
            <input placeholder='Email' type='email'
            className='w-full  px-4 py-4 border-2 border-[#556987] rounded-md mb-8' />
            </div>
