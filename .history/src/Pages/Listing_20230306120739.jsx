  ...
  return (
    <main>
      ...
      <div className=' max-w-6xl mx-auto mt-10 px-4 grid md:grid-cols-2 gap-20'>
        ...
        <div className=' mt-24 flex bg-blue-100 items-center gap-4 text-gray-800 mr-2'>
        ...
        <div className=' mx-12 w-[300px] md:w-[370px] mr-2 rounded-3xl shadow-xl md:mx-0 text-gray-700'>  
