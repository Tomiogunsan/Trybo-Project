      ...
      <div className="flex  space-x-6 mb-6 ">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="bg-blue-800 text-white  w-full px-4 py-2 text-xl text-gray-700 bg-white border-[1px] border-[#556987]  rounded-md" />
          </div>
          <div>
            ...
            <input
              ...
              max="50"
              required
              className=" bg-blue-800 text-white w-full px-4 py-2 text-xl  bg-white border-[1px] border-[#556987]  rounded-md"/>
          </div>
        ...
        <div>
          ...
          <input
              ...
              max="50"
              required
              className="w-full mb-2 px-4 py-2 text-xl text-gray-700 bg-white border-[1px] border-[#556987]  rounded-md"/>
          </div>
