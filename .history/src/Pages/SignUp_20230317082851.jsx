  ...
  return (
    <div>
      ...
      mb-6 "
          ...
          >
            <div className=" mt-4 mb-2 border border-[#556987] p-4 rounded-sm  w-full  md:w-[50%]">
              <input
                type="email"
                id="email"
            ...
            <div className="border border-[#556987] mb-[10px] p-4 rounded-sm  w-full md:w-[50%] ">
              <input
                type="text"
                id="name"
                placeholder="Name"
            ...
            <div className=" relative mb-[] border border-[#556987] p-4 rounded-sm  w-full md:w-[50%] ">
              <input
