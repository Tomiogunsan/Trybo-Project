    ...
    <>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute w-full h-full left-0 top-0 bg-gray-500/30 ">
          <form className="absolute flex flex-col items-center justify-centermd:right-[100px] md:top-[30%] bg-white w-full md:w-[45%] rounded-xl px-8 shadow-lg shadow-black">
