      ...
      {homeListing.map((listing, index) => (
        <div className={`grid md:grid-cols-2 w-[70%] text-[#404040] mb-6 ${homeListing.length - 1 === index ? 'border-b-0' : 'border-b-2 border-gray-300'}`}>
          ...
          <div>
            ...
            <p className='text-'>{(listing.bedrooms === '1' ) ? 'Sleep up to 2' :
             (listing.bedrooms === '2') ? 'Sleep up to 4' : 'Sleep up to 6'
             } .</p>
              <p className='md:ml-2'>{listing.bedrooms > 1 ? `${listing.bedrooms} Beds` : "1 Bed"} .</p>
              <p className='md:ml-2'>{listing.bathroom > 1 ? `${listing.bathroom} Bathrooms` : "1 Bathroom"}</p>
