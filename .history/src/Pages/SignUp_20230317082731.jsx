  ...
  return (
    <div>
      ...
      mb-6 "
          ...
          >
            <div className=" mt-4  border border-[#556987] p-4 rounded-sm  w-full  md:w-[50%]">
              <input
                type="email"
                id="email"
                ...
                className="outline-none w-full pb-2"
              />
              
            </div>
            {errors.email && (
                <span className="text-red-600 mb-4 text-sm capitalize">
                  {errors.email}
                </span>
              )}

            <div className="border border-[#556987] p-4 rounded-sm  w-full md:w-[50%] ">
              <input
                type="text"
                id="name"
                placeholder="Name"
            ...
            <div className=" relative border border-[#556987] p-4 rounded-sm  w-full md:w-[50%] ">
              <input
