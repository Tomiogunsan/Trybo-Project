...
export default function BlogCard() {
  return (
    <div className='  mt-24'>
        ...
        <p className='text-lgmt md:w-[66%] lg:w-[42%] tracking-wider'>From latest news to team interviews, learn more about the passion that powers a Sonder.</p>
       ...
       {Array(3).fill(content).map((item, index) =>
            ...
            <div key={index} >
                ...
                <img src={item.image} alt='/' className='w-[400px] '/>
                    <h2 className='text-lg pb-14'>{item.title}</h2>
                    <p>{item.link}</p>
