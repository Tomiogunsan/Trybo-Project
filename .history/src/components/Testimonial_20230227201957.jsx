...
export default function Testimonial() {
  return (
    ...
    >
        <SwiperSlide>
            <div className='bg-blue-900 text-white rounded-bl-[90px] w-[480px] h-[300px]'>
                ...
                <p className='px-10 md:pt-12 text-lg'>Mark</p>

            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='bg-violet-900 text-white rounded-tr-[90px] w-[480px] h-[300px]'>
                <p className='text-2xl py-9 px-10'>
        ...
        <SwiperSlide>
            <div className='bg-gray-900 text-white rounded-tr-[90px] w-[480px] h-[300px]'>
                <p className='text-2xl py-9 px-10'>
        ...
        <SwiperSlide>
            <div className='bg-yellow-900 text-white rounded-bl-[90px] w-[480px] h-[300px]'>
                <p className='text-2xl py-9 px-10'>
        ...
        <SwiperSlide>
            <div className=' bg-slate-800 text-white rounded-bl-[90px] w-[480px] h-[300px]'>
                <p className='text-2xl py-9 px-10'>
