...
export default function Booking() {
  ...
  return (
    <div >
        <form className='flex flex-col lg:flex-row justify-center items-center rounded-lg md:w-[50%] md:mx-auto lg:w-[600px] lg:mx-auto bg-white text-black mx-4 md:m-11' >
