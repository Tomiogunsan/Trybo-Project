...
export default function Testimonial() {
  return (
    ...
    >
        ...
        <SwiperSlide>
            <div className='bg-yellow-900 text-white rounded-bl-[90px]  md:w-full h-[500px] md:h-[270px]'>
                <p className='text-2xl pt-2 px-10'>
        ...
        <SwiperSlide>
            <div className=' bg-slate-800 text-white rounded-bl-[90px]  w-full h-[500px] md:h-[270px]'>
                <p className='text-2xl pt-2 px-10'>
