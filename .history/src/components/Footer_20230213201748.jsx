...
export default function Footer() {
  return (
    ...
    <div className='flex justify-between mt-16'>
      <div>
        <p>© 2023 Vrbo, an <span>Expedia Group</span> company. All rights reserved.</p>
        <p className='text-blue-800 font-semibold'>Terms and Conditions · Privacy Policy · Your Privacy Choices</p>
      </div>
      <div>B</div>
    </div>
    </Container>
