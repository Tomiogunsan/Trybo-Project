...
export default function BlogPostOne() {
  ...
  return (
    ...
    <div>
       ...
       <div className=' pt-20 text-xl pb-14'>
        {post.DescriptionA}
       </div>

        <div className='flex  '>
            <img src={post.imageB} alt='an apartment' className='w-[30%] mx-auto '/>
            <img src={post.imageC} alt='an apartment' className='w-[30%] mx-auto ' />
        </div>
