  ...
  return (
    ...
    className="md:shadow-xl md:rounded-lg md:max-w-4xl md:mx-auto mt-8">
      ...
      mb-6 "
        ...
        <div  className="border border-[#556987] p-4 rounded-sm  w-full md:w-[50%] mt-4 mb-3 ">
          <input
            type="email"
            name="email"
        ...
        {formik.errors.email ? <div className='text-red-600 text-sm mr-[200px]'>{formik.errors.email}</div> : null}
        ...
        {formik.errors.firstName ? <div className='text-red-600 text-sm'>{formik.errors.firstName}</div> : null}
        ...
        {formik.errors.lastName ? <div className='text-red-600 text-sm'>{formik.errors.lastName}</div> : null}
        ...
        {formik.errors.password ? <div className='text-red-600 text-sm' >{formik.errors.password}</div> : null}
