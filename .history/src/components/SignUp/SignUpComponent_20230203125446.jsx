  ...
  return (
    ...
    className="md:shadow-xl md:rounded-lg md:max-w-4xl md:mx-auto mt-8">
      ...
      mb-6 "
        ...
        {formik.errors.email ? <div className='text-red-600 text-sm'>{formik.errors.email}</div> : null}
        ...
        <div className="border border-[#556987] p-4 rounded-sm mb-6 w-full md:w-[50%]  ">
          <input
            ...
            onChange={formik.handelChange}
            className="outline-none"
          />
        </div>
        {formik.errors.lastName ? <div className='text-red-600 text-sm'>{formik.errors.lasttName}</div> : null}
