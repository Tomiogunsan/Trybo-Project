  ...
  return (
    ...
    className="md:shadow-xl md:rounded-lg md:max-w-4xl md:mx-auto mt-8">
      ...
      mb-6 "
        ...
        {formik.errors.firstName ? <div className='text-red-600 text-sm mr-[200px] mb-2'>{formik.errors.firstName}</div> : null}
        ...
        {formik.errors.lastName ? <div className='text-red-600 text-sm mr-[200px] mb-2'>{formik.errors.lastName}</div> : null}
        ...
        {formik.errors.password ? <div className='text-red-600 text-sm mr-[200px] mb-2' >{formik.errors.password}</div> : null}
