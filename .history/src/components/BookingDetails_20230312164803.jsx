...
console.log(config.publicKey);
  ...
  return (
    <Modal>
     ...
     <div>
     <p className='pl-8 font-medium text-xl pt-4'>{bookingDetails.roomName}</p>
     <p className='pl-8 text-base text-gray-600'>{bookingDetails.numberOfNight > 1 ? `${bookingDetails.numberOfNight} Nights` : '1 Nights'}  for  ₦{bookingDetails.price}</p>
