  ...
  return (
    <div>
      <form className="flex flex-col lg:flex-row justify-center items-center rounded-3xl md:w-[50%] md:mx-auto lg:w-[800px] lg:mx-auto bg-white text-black mx-4 md:m-11">
        <div className="flex px-[4px] gap-2 items-center my-2 py-2 lg:border-r-2 pr-2 text-[#404040]">
            <label className="lg:hidden text-gray-400 "> Add destination</label>
          <input placeholder="Check in" className='border-[1px] py-2 px-2 rounded-md lg:border-0 lg:py-0 lg:px-0' />
        </div>
        <div className=" hidden lg:flex  pl-4 items-center lg:border-r-2 pr-4 p-2 text-[#404040]">
