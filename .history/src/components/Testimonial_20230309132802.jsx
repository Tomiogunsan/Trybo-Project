...
export default function Testimonial() {
  return (
    ...
    >
        <SwiperSlide>
            <div className='bg-blue-900 text-white rounded-bl-[90px] w-full md:marker:h-[270px] '>
        ...
        <SwiperSlide>
            <div className='bg-violet-900 text-white rounded-tr-[90px] w-full h-[270px]'>
                <p className='text-2xl pt-2 px-10'>
        ...
        <SwiperSlide>
            <div className='bg-gray-900 text-white rounded-tr-[90px]  w-full h-[270px] '>
                <p className='text-2xl pt-2 px-10'>
        ...
        <SwiperSlide>
            <div className='bg-yellow-900 text-white rounded-bl-[90px]  w-full h-[270px]'>
                <p className='text-2xl pt-2 px-10'>
