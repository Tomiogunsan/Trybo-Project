  ...
  return (
    ...
    <div>
       ...
       <div className=' pt-20 text-xl pb-12'>
        ...
        <div className='flex gap-2 max-w-4'>
            <img src={post.imageB} alt='an apartment' className='w-[30%] h-[20%] mx-auto'/>
            <img src={post.imageC} alt='an apartment' className='w-[30%] h-[20%] mx-auto' />
        </div>
