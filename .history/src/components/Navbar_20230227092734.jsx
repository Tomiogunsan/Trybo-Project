...
export default function Navbar() {
  ...
  return (
    <div className=' w-full flex justify-between items-center cursor-pointer absolute text-blue-900 font-medium z-[1] bg-white/90   '>
        <div >
            <img src={logo} 
            alt='logo'
            className=' w-[50%] '
            ...
            {/* mobile menu */}
        <div onClick={handleNav} className={nav ? 'absolute items-center bg-black left-0 top-0 w-full h-full px-4 py-7 flex flex-col z-10' : 'absolute left-[-100%]'}>
        <div >
            <img src={logo} 
            alt='logo'
            className=' w-[50%] '
            ...
            <ul className='flex  flexitems-center '>
                <NavLink to={pageState ? '/sign-in' : '/profile'} className='mr-6'>
                    <li className='flex items-center text-md'>
