...
export default function Booking() {
  ...
  return (
    <div >
        <form className='flex flex-col lg:flex-row justify-center items-center rounded-lg md:w-[50%] md:mx-auto lg:w-[700px] lg:mx-auto bg-white text-black mx-4 md:m-11' >
            <div className='flex  gap-2 items-center my-2 py-2 lg:border-r-2 pr-2 text-[#404040]'>
                ...
                className=' w-[40%] rounded-md p-2 outline-0'
                />
