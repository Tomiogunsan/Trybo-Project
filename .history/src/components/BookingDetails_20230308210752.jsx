...
export default function BookingDetails(props) {
  ...
  const config = {
    ...
    amount: bookingDetails.price, //Amount is in the country's lowest currency. E.g Kobo, so 20000 kobo = N200
    publicKey: process.env.REACT_PAYSTACK_ID,
  };
...
{ bookingDetails.numberOfNight > 0 &&
      <div className=" flex flex-col items-center justify-center mt-10 mb-4">
        <PaystackButton className="uppercase rounded-md bg-blue-800 hover:bg-blue-900 cursor-pointer px-20 py-2 text-white">
          Pay now
        </PaystackButton>
