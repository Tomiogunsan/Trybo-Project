...
export default function Testimonial() {
  return (
    <Container>
    <div className=' hidden mt-11 text-[#404040] pb-11 px-4'>
    ...
    >
        <SwiperSlide>
            <div className='bg-blue-900 text-white rounded-bl-[90px] w-[360px] h-[300px] md:w-full md:h-[270px] '>
                <p className='text-2xl pt-2 px-10'>
                "Love the app! It works like magic and all the information 
                is super helpful to make the experience seamlesss "
                </p>
                <p className='px-10  pt-16 text-center text-lg'>Mark</p>

            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='bg-violet-900 text-white rounded-tr-[90px]  w-[360px] h-[300px] md:w-full md:h-[270px]'>
                <p className='text-2xl pt-2 px-10'>
                ...
                <p className='px-10 pt-2 text-center text-lg'>Jane</p>

            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='bg-gray-900 text-white rounded-tr-[90px] w-[360px] h-[300px] md:w-full md:h-[270px] '>
                <p className='text-2xl pt-2 px-10'>
                ...
                <p className='px-10 pt-2 mb-2 text-center text-lg'>Mandy</p>

            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='bg-yellow-900 text-white rounded-bl-[90px] w-[360px] h-[300px]  md:w-full  md:h-[270px]'>
                <p className='text-2xl pt-2 px-10'>
                "This Unit was perfect! I needed a furnished apartment for a few 
                months and Trybo thought of everything! "
                </p>
                <p className='px-10 pt-16 text-center text-lg'>Leah</p>

            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className=' bg-slate-800 text-white rounded-bl-[90px] w-[360px] h-[300px] md:w-full  md:h-[270px]'>
                <p className='text-2xl pt-2 px-10'>
                "Our stay at the Wellborne was absolutely fabulous! The  check-in
                process was a breeze. 
                </p>
                <p className='px-10 pt-16 text-center text-lg'>Mercy</p>
